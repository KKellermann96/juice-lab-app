  ...
  >
    ...
    >
      ...
      <div v-if="!startGame" class="mb-5 flex gap-5 z-10">
        ...
        <FancyButton :action="goBack" icon="home" color="purple" text="Go Back">
        </FancyButton>
      </div>
          ...
          <div v-if="!toggleControlls" class="flex flex-col gap-2">
            ...
            <div>
              <p class="mb-2">
                ...
                >
                - a 2D shooter demo that takes place in a futuristic world full
                of menace and action! You take control of an advanced cyborg who
                must fight his way through an endless sequence of procedurally
              ...
              <p>
                ...
                resource to escape the pressure: The "S" key allows you to pause
      ...
      <img
        ...
        src="/images/arcadeBackground.jpg"
